...
export default function FeaturesPrestige() {
  return (
    <section className="py-12 md:py-24 bg-[#080808] text-white overflow-hidden relative">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        {/* تعديل الـ gap ليكون أصغر في التليفون */}
          ...
          {features.map((feature, i) => (
            ...
            >
              ...
              <div className="mb-6 md:mb-8 relative">
                <div 
                  className="w-14 h-14 md:w-16 md:h-16 rounded-2xl flex items-center justify-center transition-all duration-500 group-hover:rotate-[10deg] shadow-2xl"
              ...
              <h3 className="text-lg md:text-xl font-black uppercase tracking-tighter italic border-l-2 border-[#580303] pl-4 md:pl-5 mb-4 md:mb-5 transition-all group-hover:border-[#D4AF37]">
                {feature.title}
              </h3>

              {/* Description - تحسين مقروئية النص في الموبايل */}
              <p className="text-white/40 text-[9px] md:text-[11px] font-bold leading-relaxed uppercase tracking-[0.15em] md:tracking-[0.2em] max-w-[280px]">
                {feature.desc}
              </p>
            </motion.div>
          ))}
